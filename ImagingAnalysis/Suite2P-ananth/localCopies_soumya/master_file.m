...
%% Post Suite2p analysis  
  ...
  %%       
   ...
   %%  Analysis of mixed trials
   
   %Plot All cells Full Trial- Sorted

 Plot_sorted_allCells (db(iexp), dfbf, trialDetails, figureDetails, dfbf_2D_sorted_timeCells)
 ...
 [sound_trials, light_trials] = sortTrialsByModality (db(iexp));
  ...
  modalitySpecificSortingAndPlotting (db(iexp),dfbf, timeLockedCells, light_trials,sound_trials, window,trialPhase,figureDetails);
